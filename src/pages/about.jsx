          ...
          <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3">
            {announcements.map((item) => (
              <a key={item.id} href={`/about/${item.id}`}>
                <div className="transition ease-in-out hover:-translate-y-6 hover:shadow-indigo-500/40 relative flex flex-col bg-clip-border  bg-transparent text-gray-700 shadow-lg grid min-h-[30rem] items-end overflow-hidden rounded-xl">
                  <img
